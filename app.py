...
# postgres://pilahunt_user:yDzp0HW6zhiPd73cFBovGLyCTDU4rHtf@dpg-cpe1idf109ks73eo886g-a.singapore-postgres.render.com/pilahunt
...
def spes_edit_profile():
    if session.get('spes_email'):
        spes = SPES.query.filter_by(spes_email=session['spes_email']).first()
        if spes:
            spes.spes_firstname = request.form['spes_firstname']
            spes.spes_middlename = request.form['spes_middlename']
            spes.spes_lastname = request.form['spes_lastname']
            spes.spes_email = request.form['spes_email']
            spes.spes_address = request.form['spes_address']
            spes.spes_gender = request.form['spes_gender']
            spes.spes_phoneno = request.form['spes_phoneno']
            spes.spes_civil = request.form['spes_civil']
            spes.spes_spestype = request.form['spes_spestype']
            spes.spes_mofirstname = request.form['spes_mofirstname']
            spes.spes_momiddlename = request.form['spes_momiddlename']
            spes.spes_molastname = request.form['spes_molastname']
            spes.spes_fafirstname = request.form['spes_fafirstname']
            spes.spes_famiddlename = request.form['spes_famiddlename']
            spes.spes_falastname = request.form['spes_falastname']
            spes.spes_elemschool = request.form['spes_elemschool']
            spes.spes_elemgrad = request.form['spes_elemgrad']
            spes.spes_junschool = request.form['spes_junschool']
            spes.spes_jungrad = request.form['spes_jungrad']
            spes.spes_senschool = request.form['spes_senschool']
            spes.spes_sengrad = request.form['spes_sengrad']
            spes.spes_strand = request.form['spes_strand']
            spes.spes_colschool = request.form['spes_colschool']
            spes.spes_course = request.form['spes_course']
            spes.spes_colgrad = request.form['spes_colgrad']
            spes.spes_facontact = request.form['spes_facontact']
            spes.spes_mocontact = request.form['spes_mocontact']
            spes.spes_moocupation = request.form['spes_moocupation']
            spes.spes_faocupation = request.form['spes_faocupation']
            spes.spes_citizenship = request.form['spes_citizenship']
            spes.spes_gsisbeneficiary = request.form['spes_gsisbeneficiary']
            spes.spes_social = request.form['spes_social']
            spes.spes_gsisstatus = request.form['spes_gsisstatus']
            spes.spes_presentadd = request.form['spes_presentadd']
            spes.spes_permanentadd = request.form['spes_permanentadd']
            spes.spes_elemlvl = request.form['spes_elemlvl']
            spes.spes_junlvl = request.form['spes_junlvl']
            spes.spes_collvl = request.form['spes_collvl']

            # Handle birthday field
            spes_birthday_str = request.form['spes_birthday']
